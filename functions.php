...
if (!function_exists('mytheme_customize_register')) {
    function mytheme_customize_register($wp_customize) {
        ...
        // Impostazione per l'immagine del Hero
        ...
        // Impostazione per il titolo della Hero Page
        $wp_customize->add_setting('hero_title', array(
            'default'           => 'Main title and motto',
            'sanitize_callback' => 'sanitize_text_field',
        ));

        // Controllo per il titolo della Hero Page
        ...
        // ROOM PAGE: Sezione Testo e Immagini
        ...
        // Aggiungi controlli per le immagini
        $images = array(
